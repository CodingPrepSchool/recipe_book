...
recipes = [
     ...
     "ingredients": ['2 tablespoons extra-virgin olive oil', '1 minced shallot', 
...
' Serve warm.']
     ...
     {"id": 2, 
     "name": "French Toast", 
     "ingredients": ['1 egg', '1 teaspoon Vanilla Extract', '1/2 teaspoon Ground Cinnamon', '1/4 cup milk', '4 slices bread'],
     "instructions": ['Beat egg, vanilla and cinnamon in shallow dish with wire whisk. Stir in milk.', 
' Cook bread slices on lightly greased nonstick griddle or skillet on medium heat until browned on both sides. Serve with Easy Spiced Syrup, if desired. Voila, easy French toast.',
...
# for num in numbers:
#      print(num)
# recipes = ["Omelet", "french toast", "grilled cheese"]
# for item in recipes:
#      print(item)
# for dict in recipes:
